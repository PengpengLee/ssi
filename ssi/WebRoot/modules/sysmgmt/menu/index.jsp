...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="modal fade" id="menu-add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									...
									<form role="form" id="add_data" class="form-horizontal" action="javascript:void(0);">
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" name="name" class="form-control" placeholder="菜单管理">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">访问路径</label>
												<div class="col-md-9">
													<input name="actionUrl" type="text" class="form-control" placeholder="/menu/index.action">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<select name="roleId" class="form-control">
														<option value="10">老师（管理员）</option><!-- 老师 -->
														<option value="20">学员（普通用户）</option><!-- 学员 -->
														<option value="5">主管（权限管理员）</option><!-- 主管 -->
														<option value="1">系统管理员</option><!-- 你猜。。。 -->
													</select>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="input-icon col-md-9">
													<i class="icon-action-redo" data-container="body"></i>
													<select name="icon" class="form-control">
													</select>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">配色</label>
												<div class="input-icon col-md-9">
				...
				<div class="col-sm-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="#menu-add" onclick="resetForm()" data-toggle="modal" class="btn btn-default btn-sm">
									...
									<form role="form" action="javascript:void(0);" onsubmit="return checkForm(this);">
										<div class="form-body">
											<div class="form-group form-md-line-input form-md-floating-label">
												...
												<label for="form_control_1">按菜单名称查询</label>
												<span class="help-block">输入后回车</span>
											</div>
										</div>
									</form>
								</div>
...
<script src="${ctx}/modules/sysmgmt/menu/js/index.js" type="text/javascript"></script>
